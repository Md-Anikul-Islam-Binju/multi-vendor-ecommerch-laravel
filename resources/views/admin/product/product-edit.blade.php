                            ...
                            <div class="row" style="align-items: flex-start; overflow: visible;">
                                <div class="col-md-9 divrigth_border sticky-conent">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label class="" for="selling_price">Selling Price</label>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input required type="number" value="{{$product->reseller_price}}" min="0" name="reseller_price" id="reseller_price" placeholder = 'Enter Reselling price' class="form-control" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-9">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" value="{{$product->discount <= 0?0:$product->selling_price - $product->discount}}"  name="discount_price" id="discount_price" placeholder = 'Enter discount Price' class="form-control" >
                                            </div>
                                        </div>


                                        <div class="col-md-1 col-3 d-none" style="padding-left: 0">
                                            <div class="form-group">
                                       ...
                                       <div class="col-md-12 title_head">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2 nopadding">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$variationDetail->sku}}" class="form-control sku" name="skuUpdate[{{$variation->attribute_id}}][]" placeholder="Enter SKU">
                                                        </div>
                                                    </div> 
                                                    <!-- check qty weather set or not -->
                                                        ...
                                                        <div id="attribute{{$attribute->id}}" style="display: none;">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-{{$col}} nopadding">
                                                                    <div class="form-group">
                                                                        <span>SKU</span>
                                                                        <input type="text" class="form-control sku" name="sku[{{$attribute->id}}][]"  placeholder="SKU" readonly>
                                                                    </div>
                                                                </div>
                                                                <!-- check qty weather set or not -->
                                                                @if($attribute->qty)
                                        ...
                                        <div class="col-md-12">
                                        	<div class="form-group">
	                                           ...
	                                           <textarea style="resize: vertical;" rows="3" name="summery" class="form-control newtextarea">{{$product->summery}}</textarea>
	                                       </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="required">Product Description</label>
                                               <textarea required name="description" class="summernote form-control newtextarea">{{$product->description}}</textarea>
                                           </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="required">Product Specification</label>
                                               <textarea required name="specification" class="summernote form-control newtextarea">{{$product->specification}}</textarea>
                                           </div>
                                        </div>
                                ...
                                <div class="col-md-3 sticky-conent">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="required" for="stock">Product Weight (Kg)</label>
                                                <input type="text" value="{{ $product->weight }}"  name="weight" id="weight" placeholder = 'Example: 1kg' class="form-control" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $product->sku }}"  name="sku" id="sku" placeholder = 'Example: sku-120' class="form-control sku" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <h3>gallery image</h3>
                                                @if($product->get_galleryImages->count() > 0)
                                                    @foreach($product->get_galleryImages as $image)
                                                        <img src="{{ asset('upload/images/product/gallery/'. $image->image_path) }}" alt="failed" width="120" height="100">
                                                    @endforeach
                                                @else
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="vendor_id" required id="vendor" style="width:100%" id="vendor" class="select2 form-control custom-select">
                                                   ...
                                                   <option  data-name="{{substr($vendor->vendor_name,0,1).substr($vendor->shop_name,0,1)}}"  @if($product->vendor_id == $vendor->id) selected @endif   value="{{$vendor->id}}">{{$vendor->shop_name}}</option>
                                                   @endforeach
                                               </select>
                                           </div>
                                        </div>
