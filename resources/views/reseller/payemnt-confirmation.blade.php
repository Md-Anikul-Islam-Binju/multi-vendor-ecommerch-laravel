...
@section('content')
		...
		<br>
		<br>
		<div class="main-container container py-5" id="customer-print">
			<div class="row">
				<!--Middle Part Start-->
				<div id="content" class="col-md-12">
					...
					<h2 class="title">Order Information[Customer]</h2>
						...
						<table class="table table-bordered table-hover">
							...
							@foreach($order['order_details'] as $item)
								...
								<tr>
									...
									<td class="text-right">{{$order['currency_sign']. $item['customer_price']}}</td>
									<td class="text-right">{{$order['currency_sign']. $item['customer_price']*$item['qty']}}</td>
		...
		<div class="main-container container py-5" id="reseller-print">
			<div class="row">
				<!--Middle Part Start-->
				<div id="content" class="col-md-12">
					<div class="order_success">
					...
					<h2 class="title">Order Information[Reseller]</h2>
