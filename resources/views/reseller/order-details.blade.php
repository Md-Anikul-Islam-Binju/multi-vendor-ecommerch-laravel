	...
	<div class="container">
		<div class="row">
			...
			<div id="content" style="position:sticky;" class="col-md-9 sticky-content">
				<h2 class="title"><a href="{{ route('reseller.orderHistory') }}"> <i class="fa fa-angle-left"></i>  Order Details #{{ $order->order_id }}</a></h2>
					...
					<table class="table table-bordered table-hover">
						<thead>
							<tr>
								...
								<td class="text-right">Customer Price</td>
              ...
              @if($order_detail->product)            
                    ...
                    @endif
								...
								<td class="text-right">{{$order->currency_sign. $order_detail->customer_price}}</td>
								<td class="text-right">{{$order->currency_sign. $order_detail->customer_price*$order_detail->qty}}</td>
...
{{--									  </ul>--}}
						...
						<tfoot>
							<tr>
								...
								<td></td>
								<td class="text-right">{{$order->currency_sign . $order->customer_total_price}}</td>
								<td colspan="2"></td>
							</tr>
							<tr>
								<td colspan="2"></td>
							...
							<tr>
								...
								<td></td>
								<td class="text-right">{{$order->currency_sign . ($order->customer_total_price + $order->shipping_cost - $order->coupon_discount)  }}</td>
							</tr>
							<tr>
								<td colspan="2"></td>
								<th>Profit</th>
								<td>{{$order->currency_sign}}{{  ($order->customer_total_price + $order->shipping_cost - $order->coupon_discount) - ($order->total_price + $order->shipping_cost - $order->coupon_discount)}} </td>
							</tr>
						</tfoot>
					</table>
				</div>
