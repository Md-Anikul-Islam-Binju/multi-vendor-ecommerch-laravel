			...
			<div id="content" class="col-sm-12">
				...
				<div class="so-onepagecheckout layout1 row">
					<div class="col-left col-lg-6 col-md-6 col-sm-6 col-xs-12 sticky-content">
						<form action="{{ route('resellerCustomer.store') }}" name="shipping_form" id="shipping_form" data-parsley-validate method="post" class="form-horizontal form-shipping">
						@csrf						
						<div class="checkout-content checkout-register">
							<fieldset id="account">
								<h2 class="secondary-title">Customer Billing Details</h2>
								<div class=" box-inner">
									
									<div class="form-group input-firstname required" >
										<span>Customer  Name</span>
										<input type="text" name="name" required value="{{old('name')}}" placeholder="Full Name *" id="fullname_required" class="form-control">
									</div>
									...
									<div class="p-5">
										<h2 class="secondary-title">Shipping Address (customer)</h2>
									</div>
        ...
        if ($("#register").is(":checked")) {
	        ...
	        if(value != ""){
	            $.ajax({
	                ...
	                data:{table:'reseller_customers', field:field, value:value, type:type},
	                success:function(data){
